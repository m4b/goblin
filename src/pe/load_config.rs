...
impl<'a> LoadConfigData<'a> {
    ...
    pub fn time_stamp(&self) -> Option<u32> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, time_stamp),
            u32
        )
    }
    ...
    pub fn major_version(&self) -> Option<u16> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, major_version),
            u16
        )
    }
    ...
    pub fn minor_version(&self) -> Option<u16> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, minor_version),
            u16
        )
    }
    ...
    pub fn global_flags_clear(&self) -> Option<u32> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, global_flags_clear),
            u32
        )
    }
    ...
    pub fn global_flags_set(&self) -> Option<u32> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, global_flags_set),
            u32
        )
    }
    ...
    pub fn critical_section_default_timeout(&self) -> Option<u32> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, critical_section_default_timeout),
            u32
        )
    }
    ...
    pub fn process_heap_flags(&self) -> Option<u32> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, process_heap_flags),
            u32
        )
    }
    ...
    pub fn csd_version(&self) -> Option<u16> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, csd_version),
            u16
        )
    }
    ...
    pub fn dependent_load_flags(&self) -> Option<u16> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, dependent_load_flags),
            u16
        )
    }
    ...
    pub fn edit_list(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, edit_list))
    }

    /// Returns the value of [LoadConfigDirectory::security_cookie].
    pub fn security_cookie(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, security_cookie))
    }

    /// Returns the value of [LoadConfigDirectory::se_handler_table].
    pub fn se_handler_table(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, se_handler_table))
    }

    /// Returns the value of [LoadConfigDirectory::se_handler_count].
    pub fn se_handler_count(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, se_handler_count))
    }
    ...
    pub fn guard_cf_function_table(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, guard_cf_function_table))
    }

    /// Returns the value of [LoadConfigDirectory::guard_cf_function_count].
    pub fn guard_cf_function_count(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, guard_cf_function_count))
    }
    ...
    pub fn guard_flags(&self) -> Option<u32> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, guard_flags),
            u32
        )
    }
    ...
    pub fn code_integrity(&self) -> Option<LoadConfigCodeIntegrity> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, code_integrity),
    ...
    pub fn dynamic_value_reloc_table(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, dynamic_value_reloc_table))
    }

    /// Returns the value of [LoadConfigDirectory::chpe_metadata_pointer].
    pub fn chpe_metadata_pointer(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, chpe_metadata_pointer))
    }

    /// Returns the value of [LoadConfigDirectory::guard_rf_failure_routine].
    pub fn guard_rf_failure_routine(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, guard_rf_failure_routine))
    }
    ...
    pub fn dynamic_value_reloc_table_offset(&self) -> Option<u32> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, dynamic_value_reloc_table_offset),
            u32
        )
    }
    ...
    pub fn dynamic_value_reloc_table_section(&self) -> Option<u16> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, dynamic_value_reloc_table_section),
            u16
        )
    }
    ...
    pub fn reserved2(&self) -> Option<u16> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, reserved2),
            u16
        )
    }
    ...
    pub fn hot_patch_table_offset(&self) -> Option<u32> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, hot_patch_table_offset),
            u32
        )
    }
    ...
    pub fn reserved3(&self) -> Option<u32> {
        have_field!(
            self.bytes,
            self.size,
            offset_of!(LoadConfigDirectory, reserved3),
            u32
        )
    }
    ...
    pub fn volatile_metadata_pointer(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, volatile_metadata_pointer))
    }

    /// Returns the value of [LoadConfigDirectory::guard_eh_continuation_table].
    pub fn guard_eh_continuation_table(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, guard_eh_continuation_table))
    }

    /// Returns the value of [LoadConfigDirectory::guard_eh_continuation_count].
    pub fn guard_eh_continuation_count(&self) -> Option<u64> {
        self.read_arch_dependent_u64(offset_of!(LoadConfigDirectory, guard_eh_continuation_count))
    }
...
mod tests {
    ...
    fn test_load_config_sizes() {
        // 192 bytes for 32-bit, 320 bytes otherwise.
        assert_eq!(core::mem::size_of::<LoadConfigDirectory>(), 320);
    }

    #[test]
    fn test_parse_load_config_data0() {
        let size = LOADCONFIG0.pread::<u32>(0).unwrap();
