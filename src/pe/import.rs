...
impl HintNameTableEntry {
    fn parse<B: scroll::Gread + scroll::Gread<scroll::Error, u8>>(bytes: &B, mut offset: usize) -> error::Result<Self> {
        let mut offset = &mut offset;
        let hint = bytes.gread(offset, scroll::LE)?;
        let name = bytes.pread::<&str>(*offset, 0)?.to_string();
...
impl ImportLookupTableEntry {
    pub fn parse<B: scroll::Gread + scroll::Gread<scroll::Error, u8>>(bytes: &B, mut offset: usize, sections: &[section_table::SectionTable])
...
impl SyntheticImportDirectoryEntry {
    pub fn parse<B: scroll::Gread + scroll::Gread<scroll::Error, u8>>(bytes: &B, import_directory_entry: ImportDirectoryEntry, sections: &[section_table::SectionTable]) -> error::Result<Self> {
        let le = scroll::LE;
...
impl ImportData {
    pub fn parse<B: scroll::Gread + scroll::Gread<scroll::Error, u8>>(bytes: &B, dd: &data_directories::DataDirectory, sections: &[section_table::SectionTable]) -> error::Result<Self> {
...
impl Import {
    pub fn parse<B: scroll::Gread + scroll::Gread<scroll::Error, u8>>(_bytes: &B, import_data: &ImportData, _sections: &[section_table::SectionTable]) -> error::Result<Vec<Self>> {
